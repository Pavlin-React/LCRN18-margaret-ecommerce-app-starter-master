...
const Walkthrough2 = ({ animate }) => {
  ...
  let motiImage1 = useDynamicAnimation(() => ({
    top: "30%",
    left: "25%",
  }));
  let motiImage2 = useDynamicAnimation(() => ({
    top: "45%",
    left: "15%",
  }));
  let motiImage3 = useDynamicAnimation(() => ({
    top: "58%",
    left: "25%",
  }));
  let motiImage4 = useDynamicAnimation(() => ({
    top: "61%",
    left: "40%",
  }));
  let motiImage5 = useDynamicAnimation(() => ({
    top: "27%",
    left: "50%",
  }));
